...
const Footer = () => {
    return (
        <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4  py-12 mt-5 bg-black">
            <div className="flex flex-col items-center justify-center">
                <div>
                    <h3 className="okok">BuyEasy</h3>
                </div>
                ...
                <div className="flex items-center mt-6">
                    <p className="text-base leading-4 text-gray-800">
                        2022 <span className="font-semibold">BuyEasy</span>
                    </p>
